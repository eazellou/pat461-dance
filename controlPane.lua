...
function lockdown(self)
	bottom = self:Bottom()
	self:SetAnchor("BOTTOMLEFT",self.left,bottom)
end
...
lowerBlock.left = lowerBlock:Left()
lowerBlock:Handle("OnDragging", lockdown)
...
upperLeftBlock.left = upperLeftBlock:Left()
upperLeftBlock:Handle("OnDragging", lockdown)
...
upperRightBlock.left = upperRightBlock:Left()
upperRightBlock:Handle("OnDragging", lockdown)
